            ...
            <div class="col-lg-4">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="list-group">
                            <div class="list-group-item">
                                <asp:TextBox ID="TxtReservedDate" runat="server" placeholder="Reserved Date" CssClass="form-control" MaxLength="10"></asp:TextBox>
                                <Ajax:CalendarExtender ID="CalendarExtenderReservedDate" runat="server" Format="dd/MM/yyyy"
                        ...
                        <asp:Button runat="server" Text="Reserve" CssClass="btn btn-default btn-block" ValidationGroup="book" />
                    </div>
                </div>
                <!-- /.panel-body -->
            </div>
